...
func PokemonApiPokeInfoByNameCall(url string) ([]byte, error) {
...
func UnmarshalToPokemonInfo(body []byte) (Pokemon, error) {
	var pkmn Pokemon
	if err := json.Unmarshal(body, &pkmn); err != nil {
		return pkmn, errors.New("Error unmarshaling json")
	}
	return pkmn, nil
}
